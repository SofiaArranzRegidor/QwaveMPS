...
def spre(op):
    """
    Construct the left-action superoperator for an operator.
    ...
    -------
    np.ndarray
        Superoperator representing left multiplication by ``op``.
    """
...
def spost(op):
    """
    Construct the right-action superoperator for an operator.
    ...
    -------
    np.ndarray
        Superoperator representing right multiplication by ``op``.
    """
